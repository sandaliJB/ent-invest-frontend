          ...
          <div className="my-app__header-inner">
            <div className="my-app__header-text media">
              <div className="media-body">
                ...
                <div className="my-input input-group mb-3">
            ...
            <div className="d-flex justify-content-between">
                <div className="d-flex">
                    <div className="my-action-buttons my-app__header__buttons my-3">
                        <img className="my-action-button__icon rounded-circle" src="./images/client-1.jpg" style={{height:"220px", width:"auto"}}/>
                    </div>
                    <div className="my-action-buttons my-app__header__buttons my-3 mx-3">
                        <div className="mt-5 mx-5">
                            ...
                            <div className="text-primary my-2"><i className="fa-solid fa-pen-to-square"></i><span className="mx-2">Edit My Profile</span></div>
                        </div>
                    </div>
                </div>
                <div className="my-5">
          ...
          <div className="row">
            <div className="col-4">
              ...
              <div className="my-card card">
                <div className="my-card__header card-header">
                  ...
                  <a className="my-card__header-link" href="#">Details →</a>
                </div>
              ...
              <div className="my-card card">
                <div className="my-card__body card-body">
                  <div className="my-text-overline">Bank accounts and cards</div>
                  <ul className="my-list my-list--simple list-inline mb-0">
                    ...
                    <li className="my-list-item">
                      ...
                      <span className="my-list-item__text">MasterCard x-1144</span>
                    </li>
                  </ul>
                  <hr className="my-divider" />
            ...
            <div className="col-8">
              <div className="my-alert alert alert-info">
                <img className="my-alert__icon" src="./images/icon-alert.svg" />
              ...
              <div className="my-card card">
                <div className="my-card__header card-header">
                  <h3 className="my-card__header-title card-title">Pending</h3>
                  <a className="my-card__header-link" href="#">See all →</a>
                </div>
                <ul className="my-list list-group list-group-flush">
                  <li className="my-list-item list-group-item">
                    ...
                    <div className="my-list-item__text">
                      <h4 className="my-list-item__text-title">Bank of America</h4>
                      <p className="my-list-item__text-description">Withdraw to bank account</p>
                    </div>
